...
rootpath = "C:\\Users\Khushi\OneDrive\Desktop\Music"
pattern = "*.mp3"
...
listBox = tk.Listbox(canvas, fg="black", bg="pink", width=100, font=('Arial Black',15))
listBox.pack(padx=15, pady=15)

label = tk.Label(canvas, text='', bg='white', fg='blue', font=('Arial Black',12))
label.pack(pady = 15)
